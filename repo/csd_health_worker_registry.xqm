...
{
  let $orgs0 := if (exists($requestParams/id)) then csd_bl:filter_by_primary_id($doc/CSD/organizationDirectory/*,$requestParams/id) else $doc/CSD/organizationDirectory/*
