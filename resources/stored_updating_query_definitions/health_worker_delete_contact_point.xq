...
:) 
  if (exists($careServicesRequest/requestParams/contactPoint/@position)) 
    then 
	...
	then
	let  $cp :=  $providers[1]/demographic/contactPoint[position() = $careServicesRequest/requestParams/contactPoint/@position]
